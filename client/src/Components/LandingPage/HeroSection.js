                ...
                <motion.p variants={itemVariants} whileInView="visible" initial="hidden"
                          exit="exit"  >
                    {
                        ['P','a','s','u','m','a','i',' ','c','h','o','l','a','i'].map((character,index) =>(
                            <span className="text-6xl font-extrabold drop-shadow-[0_4px_10px_rgba(0,0,0,1)] hover:text-7xl hover:p-1 transition-all duration-300 cursor-pointer">{character}</span>
                        ))
                    }
                </motion.p>
